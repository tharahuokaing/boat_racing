...
const raceLogistics = {
    ...
    vipCruiser: { name: "កប៉ាល់ធំជូនពរ (Grand Blessing Cruise)", purpose: "សម្រាប់ទទួលភ្ញៀវកិត្តិយសពិសាភោជនាហារ និងទស្សនាការប្រណាំងទូក", image: "" },
    safetyUnits: { count: 50, role: "Life Guards សម្រាប់សង្គ្រោះបន្ទាន់លើផ្ទៃទឹក (Water Rescue Professionals)", image: "" },
    rounds: [
